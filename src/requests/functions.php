<?php
    ...
    class Functions extends DB{
        ...
        static function dynamicProductListing($products){
            $html='';
        ...
        static function searchProducts($searchtxt){
            try{
        ...
        static function getCurrentProduct($prid){
            try{
        ...
        static function checkoutCartDisplay(){
            $row='';
