<?php
    session_start();
    class Cart{
        static function addToCart($prId){
        ...
        static function checkProductInSession($prId){
        ...
        static function totalProductInCart(){
            $size=0;
        ...
        static function removeFromCart($prId){
            foreach($_SESSION['cart'] as $key=>$value){
                if($prId==$value['product_id']){
        ...
        static function updateQuantityInCart($prId,$updateQuantity){
            foreach($_SESSION['cart'] as $key=>$value){
                if($prId==$value['product_id']){
